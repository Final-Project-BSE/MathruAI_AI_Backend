...
class AIService:
    ...
    def is_context_pregnancy_related(self, context_text: str) -> bool:
        ...
        pregnancy_keywords = ['pregnancy', 'pregnant', 'prenatal',
                              'maternal', 'fetal', 'trimester', 'nutrition', 'exercise']
    ...
    def generate_ai_recommendation(self, user_data: dict, context_chunks: List[str]) -> str:
        ...
        Return the answer as 3 to 6 short checklist bullet points.
        Rules:
        - Each bullet must be actionable (a "task" the user can do today).
        - Keep each bullet under 18 words.
        - Use "-" at the start of each bullet.
        - Be safe and pregnancy-appropriate.
        - Consider the user's preferences.
        - No long paragraphs, no extra headings.
        
        Output format (STRICT):
        - Return ONLY bullet points, no introduction, no greeting, no headings.
        - 3 to 6 bullet points.
        - Each bullet must start with "- ".
        - Each bullet must be an actionable task for today.
