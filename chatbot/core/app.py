"""
Flask application factory and configuration - UPDATED VERSION.
"""
...
def create_app():
    ...
    # Register blueprints (UPDATED: Added recommendations blueprint)
...
def register_blueprints(app):
    """Register API blueprints - UPDATED WITH RECOMMENDATIONS."""
    ...
    from chatbot.api.recommendations_api import recommendations_bp  # NEW
    
    app.register_blueprint(health_bp)
    app.register_blueprint(rag_bp)
    app.register_blueprint(chat_bp)
    app.register_blueprint(upload_bp)
    app.register_blueprint(recommendations_bp)  # NEW
